    ...
    <div id="weeks">
      ...
      <ul id="days">
        <li  v-for="dayobject in days" :key="dayobject.id">
          <span id="notcurmonth" v-if="dayobject.day.getMonth()+1 != currentMonth">
            {{dayobject.day.getDate()}}
          </span>
          <span v-else>
            <span id="curday" v-if="dayobject.day.getFullYear() == new Date.getFullYear() && dayobject.day.getMonth() == new Date.getMonth() && dayobject.day.getDate() == new Date.getDate()">
              {{dayobject.day.getDate()}}              
            </span>
            <span id="normalday" v-else>
              {{dayobject.day.getDate()}}
            </span>
          </span>
        </li>
